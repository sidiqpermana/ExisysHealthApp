...
public class DeviceData  {
	...
	public static void printDatas ()
	{
		for (int i = 0; i < m_deviceDataList.size(); i++) {
			...
			Log.i("com.testbluetooth", "Date" + _DeviceData.m_iYear + "-" + _DeviceData.m_iMonth + "-" + _DeviceData.m_iDay
					+ " " + _DeviceData.m_iHour + ":00");
			Log.i("com.testbluetooth", "Sys" + _DeviceData.m_nSys + "Dia" + _DeviceData.m_nDia + "nMap" + _DeviceData.m_nMap);
		}
	}
}
